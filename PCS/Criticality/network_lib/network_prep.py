...
def prepare_newOD(centroid, gdf_origin):
    '''
    find the OD of the new subgraph:gdf_origin
    '''
...
def gdf_to_simplified_multidigraph(gdf_node_pos, gdf, undirected = True, simplify=True, sums=['length','total_cost']):
    '''
